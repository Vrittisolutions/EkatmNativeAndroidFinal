...
void main ()
{
  ...
  tmpvar_51 = mix (mix (finalColor_3, GridParams.ContourColorX, vec4((GridParams.ContourColorX.w * 
    (1.0 - tmpvar_11.x)
  ...
  bvec4 tmpvar_56;
  tmpvar_56 = lessThan (xlv_COLOR4, vec4(0.0, 0.0, 0.0, 0.0));
  if (any(tmpvar_56)) {
    discard;
  };
  bvec2 tmpvar_57;
  tmpvar_57 = lessThan (xlv_COLOR5, vec2(0.0, 0.0));
  if (any(tmpvar_57)) {
    discard;
  };
