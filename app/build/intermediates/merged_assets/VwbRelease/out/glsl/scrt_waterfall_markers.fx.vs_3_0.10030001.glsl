...
void main ()
{
  ...
  _texCoord_5 = ((tmpvar_3 - WorldXZOffsetSize.xy) * (1.0/(WorldXZOffsetSize.zw)));
  ...
  tmpvar_4 = tmpvar_6.x;
  tmpvar_2.y = clamp ((vTexCoord1.y * tmpvar_4), WaterFallSliceOffsset.z, WaterFallSliceOffsset.w);
