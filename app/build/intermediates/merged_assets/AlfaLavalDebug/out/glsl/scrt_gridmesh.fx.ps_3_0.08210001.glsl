...
void main ()
{
  ...
  tmpvar_48 = mix (mix (finalColor_3, GridParams.ContourColorX, vec4((GridParams.ContourColorX.w * 
    (1.0 - tmpvar_11.x)
  ))), GridParams.ContourColorZ, vec4((GridParams.ContourColorZ.w * (1.0 - tmpvar_11.z))));
  ...
  bvec4 tmpvar_53;
  tmpvar_53 = lessThan (xlv_COLOR4, vec4(0.0, 0.0, 0.0, 0.0));
  if (any(tmpvar_53)) {
    discard;
  };
  bvec2 tmpvar_54;
  tmpvar_54 = lessThan (xlv_COLOR5, vec2(0.0, 0.0));
  if (any(tmpvar_54)) {
    discard;
  };
