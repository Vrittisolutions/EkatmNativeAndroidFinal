...
void main ()
{
  ...
  tmpvar_2.x = abs(((
    (mix (tmpvar_1.y, WaterFallSliceOffsset.y, WaterFallTexCoordCalcParams.x) - WaterFallTexCoordCalcParams.y)
   / WaterFallTexCoordCalcParams.z) + WaterFallTexCoordCalcParams.w));
  tmpvar_1.w = 1.0;
