...
void main ()
{
  ...
  tmpvar_11 = (vec2(0.5, 0.5) * (outPosition_5.xy + vec2(1.0, 1.0)));
  ...
  tmpvar_13.x = tmpvar_3.y;
  tmpvar_13.y = tmpvar_12;
  tmpvar_4 = (vColor1 * PenColor);
  highp vec3 tmpvar_14;
  tmpvar_14.x = tmpvar_3.y;
  tmpvar_14.y = tmpvar_3.w;
  tmpvar_14.z = tmpvar_3.z;
  tmpvar_1.xzw = outPosition_5.xzw;
  tmpvar_1.y = -(outPosition_5.y);
  gl_Position = tmpvar_1;
  xlv_COLOR0 = tmpvar_4;
  xlv_TEXCOORD0 = tmpvar_14;
  xlv_TEXCOORD1 = mix (tmpvar_13, tmpvar_11, BrushMappingMode.xx);
}
