...
import com.vritti.inventory.physicalInventory.adapter.WifiAdapter;
...
public class WifiListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void finishActivity(WifiConfiguration mWifiConfiguration, int networkId) {
        ...
        Util_Wifi_print.savePrinterConfiguration(WifiListActivity.this, mWifiConfiguration);
        Intent intent = new Intent();
        setResult(Constants_wifi.RESULT_CODE_PRINTER, intent);
        finish();
    }
