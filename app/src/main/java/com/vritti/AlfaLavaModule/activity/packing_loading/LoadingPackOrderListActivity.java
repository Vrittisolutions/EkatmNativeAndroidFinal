...
import com.vritti.AlfaLavaModule.activity.loading.Adp_LoadingPackingOrder;
...
public class LoadingPackOrderListActivity extends AppCompatActivity {
    ...
    SQLiteDatabase sql;
    private static Adp_LoadingPackOrder adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ut = new Utility();
        cf = new CommonFunction(LoadingPackOrderListActivity.this);
        String settingKey = ut.getSharedPreference_SettingKey(LoadingPackOrderListActivity.this);
        String dabasename = ut.getValue(LoadingPackOrderListActivity.this, WebUrlClass.GET_DATABASE_NAME_KEY, settingKey);
        db = new DatabaseHandlers(LoadingPackOrderListActivity.this, dabasename);
        sql = db.getWritableDatabase();
        CompanyURL = ut.getValue(LoadingPackOrderListActivity.this, WebUrlClass.GET_COMPANY_URL_KEY, settingKey);
        EnvMasterId = ut.getValue(LoadingPackOrderListActivity.this, WebUrlClass.GET_EnvMasterID_KEY, settingKey);
        PlantMasterId = ut.getValue(LoadingPackOrderListActivity.this, WebUrlClass.GET_PlantID_KEY, settingKey);
        LoginId = ut.getValue(LoadingPackOrderListActivity.this, WebUrlClass.GET_LOGIN_KEY, settingKey);
        Password = ut.getValue(LoadingPackOrderListActivity.this, WebUrlClass.GET_PSW_KEY, settingKey);
        UserMasterId = ut.getValue(LoadingPackOrderListActivity.this, WebUrlClass.GET_USERMASTERID_KEY, settingKey);
        UserName = ut.getValue(LoadingPackOrderListActivity.this, WebUrlClass.GET_USERNAME_KEY, settingKey);
        IsChatApplicable = ut.getValue(LoadingPackOrderListActivity.this, WebUrlClass.GET_ISCHATAPPLICABLE_KEY, settingKey);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(LoadingPackOrderListActivity.this);
        recycler.setLayoutManager(layoutManager);
        adapter=new Adp_LoadingPackOrder(picklistNOList);
...
*/
        img_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String data = edt_scanPacket.getText().toString().trim();
                        ...
                        edt_scanPacket.setText("");
                        startActivity(new Intent(LoadingPackOrderListActivity.this,
                        DOPackingScanDetails.class).
                                putExtra("dono", data));
            }
        });
    ...
    public void setdonumber(String DONumber,String Pack_OrdHdrId ) {
        ...
        startActivity(new Intent(LoadingPackOrderListActivity.this, CartonScanner.class)
    ...
    private class GetPicklistNO extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                res = ut.OpenConnection(url, LoadingPackOrderListActivity.this);
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.contains("Pack_OrdHdrId")) {
                ...
                Toast.makeText(LoadingPackOrderListActivity.this, "No records Present", Toast.LENGTH_LONG).show();

            } else {
                Toast.makeText(LoadingPackOrderListActivity.this, "Server Time Out...", Toast.LENGTH_LONG).show();
            }
    ...
    protected void onResume() {
        ...
        if (isnet()) {
            ...
            try {
                ...
                new StartSession(LoadingPackOrderListActivity.this, new CallbackInterface() {
                    @Override
                    public void callMethod() {
            ...
            Toast.makeText(LoadingPackOrderListActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
        }
