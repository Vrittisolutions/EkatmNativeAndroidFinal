...
public class QCPackingOrderListActivity extends AppCompatActivity {
    ...
    SQLiteDatabase sql;
    private static Adp_QCPackingOrder adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ut = new Utility();
        cf = new CommonFunction(QCPackingOrderListActivity.this);
        String settingKey = ut.getSharedPreference_SettingKey(QCPackingOrderListActivity.this);
        String dabasename = ut.getValue(QCPackingOrderListActivity.this, WebUrlClass.GET_DATABASE_NAME_KEY, settingKey);
        db = new DatabaseHandlers(QCPackingOrderListActivity.this, dabasename);
        sql = db.getWritableDatabase();
        CompanyURL = ut.getValue(QCPackingOrderListActivity.this, WebUrlClass.GET_COMPANY_URL_KEY, settingKey);
        EnvMasterId = ut.getValue(QCPackingOrderListActivity.this, WebUrlClass.GET_EnvMasterID_KEY, settingKey);
        PlantMasterId = ut.getValue(QCPackingOrderListActivity.this, WebUrlClass.GET_PlantID_KEY, settingKey);
        LoginId = ut.getValue(QCPackingOrderListActivity.this, WebUrlClass.GET_LOGIN_KEY, settingKey);
        Password = ut.getValue(QCPackingOrderListActivity.this, WebUrlClass.GET_PSW_KEY, settingKey);
        UserMasterId = ut.getValue(QCPackingOrderListActivity.this, WebUrlClass.GET_USERMASTERID_KEY, settingKey);
        UserName = ut.getValue(QCPackingOrderListActivity.this, WebUrlClass.GET_USERNAME_KEY, settingKey);
        IsChatApplicable = ut.getValue(QCPackingOrderListActivity.this, WebUrlClass.GET_ISCHATAPPLICABLE_KEY, settingKey);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(QCPackingOrderListActivity.this);
        recycler.setLayoutManager(layoutManager);
        adapter= new Adp_QCPackingOrder(picklistNOList);
...
*/
        img_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String data = edt_scanPacket.getText().toString().trim();
                        ...
                        edt_scanPacket.setText("");
                        startActivity(new Intent(QCPackingOrderListActivity.this,
                        DOPackingScanDetails.class).
                                putExtra("dono", data));
            }
        });
    ...
    public void setdonumber(String DONumber,String Pack_OrdHdrId ) {
        ...
        startActivity(new Intent(QCPackingOrderListActivity.this, QCCartonHeaderListActivity.class)
    ...
    private class GetPicklistNO extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                res = ut.OpenConnection(url, QCPackingOrderListActivity.this);
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.contains("Pack_OrdHdrId")) {
                ...
                Toast.makeText(QCPackingOrderListActivity.this, "No records Present", Toast.LENGTH_LONG).show();

            } else {
                Toast.makeText(QCPackingOrderListActivity.this, "Server Time Out...", Toast.LENGTH_LONG).show();
            }
    ...
    protected void onResume() {
        ...
        if (isnet()) {
            ...
            try {
                ...
                new StartSession(QCPackingOrderListActivity.this, new CallbackInterface() {
                    @Override
                    public void callMethod() {
            ...
            Toast.makeText(QCPackingOrderListActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
        }
