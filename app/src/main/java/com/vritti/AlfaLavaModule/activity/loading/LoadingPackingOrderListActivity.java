...
public class LoadingPackingOrderListActivity extends AppCompatActivity {
    ...
    SQLiteDatabase sql;
    private static Adp_LoadingPackingOrder adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ut = new Utility();
        cf = new CommonFunction(LoadingPackingOrderListActivity.this);
        String settingKey = ut.getSharedPreference_SettingKey(LoadingPackingOrderListActivity.this);
        String dabasename = ut.getValue(LoadingPackingOrderListActivity.this, WebUrlClass.GET_DATABASE_NAME_KEY, settingKey);
        db = new DatabaseHandlers(LoadingPackingOrderListActivity.this, dabasename);
        sql = db.getWritableDatabase();
        CompanyURL = ut.getValue(LoadingPackingOrderListActivity.this, WebUrlClass.GET_COMPANY_URL_KEY, settingKey);
        EnvMasterId = ut.getValue(LoadingPackingOrderListActivity.this, WebUrlClass.GET_EnvMasterID_KEY, settingKey);
        PlantMasterId = ut.getValue(LoadingPackingOrderListActivity.this, WebUrlClass.GET_PlantID_KEY, settingKey);
        LoginId = ut.getValue(LoadingPackingOrderListActivity.this, WebUrlClass.GET_LOGIN_KEY, settingKey);
        Password = ut.getValue(LoadingPackingOrderListActivity.this, WebUrlClass.GET_PSW_KEY, settingKey);
        UserMasterId = ut.getValue(LoadingPackingOrderListActivity.this, WebUrlClass.GET_USERMASTERID_KEY, settingKey);
        UserName = ut.getValue(LoadingPackingOrderListActivity.this, WebUrlClass.GET_USERNAME_KEY, settingKey);
        IsChatApplicable = ut.getValue(LoadingPackingOrderListActivity.this, WebUrlClass.GET_ISCHATAPPLICABLE_KEY, settingKey);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(LoadingPackingOrderListActivity.this);
...
*/
        img_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String data = edt_scanPacket.getText().toString().trim();
                        ...
                        edt_scanPacket.setText("");
                        startActivity(new Intent(LoadingPackingOrderListActivity.this,
                        DOPackingScanDetails.class).
                                putExtra("dono", data));
            }
        });
    ...
    public void setdonumber(String DONumber,String Pack_OrdHdrId ) {
        ...
        startActivity(new Intent(LoadingPackingOrderListActivity.this, LoadingHeaderListActivity.class)
    ...
    private class GetPicklistNO extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                res = ut.OpenConnection(url, LoadingPackingOrderListActivity.this);
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.contains("Pack_OrdHdrId")) {
                ...
                Toast.makeText(LoadingPackingOrderListActivity.this, "No records Present", Toast.LENGTH_LONG).show();

            } else {
                Toast.makeText(LoadingPackingOrderListActivity.this, "Server Time Out...", Toast.LENGTH_LONG).show();
            }
    ...
    protected void onResume() {
        ...
        if (isnet()) {
            ...
            try {
                ...
                new StartSession(LoadingPackingOrderListActivity.this, new CallbackInterface() {
                    @Override
                    public void callMethod() {
            ...
            Toast.makeText(LoadingPackingOrderListActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
        }
