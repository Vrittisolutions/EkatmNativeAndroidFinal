...
public class Adp_WeightCartonPackingOrder extends RecyclerView.Adapter<Adp_WeightCartonPackingOrder.ViewHolder> {
    private List<PicklistNO> mList;
    private static MyClickListener myClickListener;
    static Context context;


    public Adp_WeightCartonPackingOrder(List<PicklistNO> list) {
        this.mList = list;
    }

    @Override
    public Adp_WeightCartonPackingOrder.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adp_WeightCartonPackingOrder.ViewHolder holder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ((WeightPackingOrderListActivity) context).setdonumber
