...
public class Adp_CartonLabelListData extends RecyclerView.Adapter<Adp_CartonLabelListData.ViewHolder> {
    private List<CartonData> mList;
    private static MyClickListener myClickListener;
    static Context context;


    public Adp_CartonLabelListData(List<CartonData> list) {
        this.mList = list;
    }

    @Override
    public Adp_CartonLabelListData.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adp_CartonLabelListData.ViewHolder holder, int i) {
