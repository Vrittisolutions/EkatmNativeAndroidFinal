...
public class Adp_CartonPackingOrder extends RecyclerView.Adapter<Adp_CartonPackingOrder.ViewHolder> {
    private List<PicklistNO> mList;
    private static MyClickListener myClickListener;
    static Context context;


    public Adp_CartonPackingOrder(List<PicklistNO> list) {
        this.mList = list;
    }

    @Override
    public Adp_CartonPackingOrder.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adp_CartonPackingOrder.ViewHolder holder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ((CartonPackingOrderListActivity) context).setdonumber
