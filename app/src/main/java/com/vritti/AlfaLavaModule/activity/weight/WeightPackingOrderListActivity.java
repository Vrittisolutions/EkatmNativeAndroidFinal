...
public class WeightPackingOrderListActivity extends AppCompatActivity {
    ...
    SQLiteDatabase sql;
    private static Adp_WeightCartonPackingOrder adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ut = new Utility();
        cf = new CommonFunction(WeightPackingOrderListActivity.this);
        String settingKey = ut.getSharedPreference_SettingKey(WeightPackingOrderListActivity.this);
        String dabasename = ut.getValue(WeightPackingOrderListActivity.this, WebUrlClass.GET_DATABASE_NAME_KEY, settingKey);
        db = new DatabaseHandlers(WeightPackingOrderListActivity.this, dabasename);
        sql = db.getWritableDatabase();
        CompanyURL = ut.getValue(WeightPackingOrderListActivity.this, WebUrlClass.GET_COMPANY_URL_KEY, settingKey);
        EnvMasterId = ut.getValue(WeightPackingOrderListActivity.this, WebUrlClass.GET_EnvMasterID_KEY, settingKey);
        PlantMasterId = ut.getValue(WeightPackingOrderListActivity.this, WebUrlClass.GET_PlantID_KEY, settingKey);
        LoginId = ut.getValue(WeightPackingOrderListActivity.this, WebUrlClass.GET_LOGIN_KEY, settingKey);
        Password = ut.getValue(WeightPackingOrderListActivity.this, WebUrlClass.GET_PSW_KEY, settingKey);
        UserMasterId = ut.getValue(WeightPackingOrderListActivity.this, WebUrlClass.GET_USERMASTERID_KEY, settingKey);
        UserName = ut.getValue(WeightPackingOrderListActivity.this, WebUrlClass.GET_USERNAME_KEY, settingKey);
        IsChatApplicable = ut.getValue(WeightPackingOrderListActivity.this, WebUrlClass.GET_ISCHATAPPLICABLE_KEY, settingKey);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(WeightPackingOrderListActivity.this);
        recycler.setLayoutManager(layoutManager);
        adapter=new Adp_WeightCartonPackingOrder(picklistNOList);
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((event.getAction() == KeyEvent.ACTION_UP &&
                    ...
                    try {
                                     ...
                                     startActivity(new Intent(WeightPackingOrderListActivity.this,
...
*//*
    ...
    public void setdonumber(String DONumber,String Pack_OrdHdrId ) {
        ...
        startActivity(new Intent(WeightPackingOrderListActivity.this, WeightCartonHeaderListActivity.class)
    ...
    private class GetPicklistNO extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.contains("Pack_OrdHdrId")) {
                ...
                Toast.makeText(WeightPackingOrderListActivity.this, "No records Present", Toast.LENGTH_LONG).show();

            } else {
                Toast.makeText(WeightPackingOrderListActivity.this, "Server Time Out...", Toast.LENGTH_LONG).show();
            }
    ...
    protected void onResume() {
        ...
        if (isnet()) {
            ...
            try {
                ...
                new StartSession(WeightPackingOrderListActivity.this, new CallbackInterface() {
                    @Override
                    public void callMethod() {
            ...
            Toast.makeText(WeightPackingOrderListActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
        }
