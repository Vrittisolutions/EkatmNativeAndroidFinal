...
public class Adp_LoadingPackingOrder extends RecyclerView.Adapter<Adp_LoadingPackingOrder.ViewHolder> {
    private List<PicklistNO> mList;
    private static MyClickListener myClickListener;
    static Context context;


    public Adp_LoadingPackingOrder(List<PicklistNO> list) {
        this.mList = list;
    }

    @Override
    public Adp_LoadingPackingOrder.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adp_LoadingPackingOrder.ViewHolder holder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ((LoadingPackingOrderListActivity) context).setdonumber
