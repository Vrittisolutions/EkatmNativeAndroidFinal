...
public class AlfaItemMasterSyncActivity extends AppCompatActivity {
   ...
   /* DownloadROWCountJSON asyncTask = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pDialog=new ProgressDialog(AlfaItemMasterSyncActivity.this);
    ...
    public void init(){
        parent = AlfaItemMasterSyncActivity.this;
    ...
    public void setListeners(){
        ...
        btn1_fromserver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isnet()) {
                    new StartSession(AlfaItemMasterSyncActivity.this, new CallbackInterface() {
                        @Override
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
         ...
         //   new LoadData().execute();
            new DownloadFileTask(AlfaItemMasterSyncActivity.this,"Downloading items...").execute();
        ...
        try {
         ...
         /*   runOnUiThread(new Runnable() {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(AlfaItemMasterSyncActivity.this,"unable to parse json response",Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    public class LoadData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute()
        {
            progressDialog= ProgressDialog.show(AlfaItemMasterSyncActivity.this, "Item Master Sync",
    ...
    public class DownloadFileTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... sUrl) {
            ...
            try {
                readFileFromAssets(AlfaItemMasterSyncActivity.this,filePathUrl);
            }
            catch (Exception e) {
                e.printStackTrace();
                //You'll need to add proper error handling here
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICKFILE_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                File file = new File(getRealPathFromUri(AlfaItemMasterSyncActivity.this,uri));//create path from uri
