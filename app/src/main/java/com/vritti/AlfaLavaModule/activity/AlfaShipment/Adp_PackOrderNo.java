...
public class Adp_PackOrderNo extends RecyclerView.Adapter<Adp_PackOrderNo.ViewHolder> {
    private List<PicklistNO> mList;
    private static MyClickListener myClickListener;
    static Context context;


    public Adp_PackOrderNo(List<PicklistNO> list) {
        this.mList = list;
    }

    @Override
    public Adp_PackOrderNo.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adp_PackOrderNo.ViewHolder holder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ((DOShipmentListActivity) context).setdonumber
