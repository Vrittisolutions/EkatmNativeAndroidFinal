...
public class Adp_PickListNumber extends RecyclerView.Adapter<Adp_PickListNumber.ViewHolder> {
    private List<PicklistNO> mList;
    private static MyClickListener myClickListener;
    static Context context;


    public Adp_PickListNumber(List<PicklistNO> list) {
        this.mList = list;
    }

    @Override
    public Adp_PickListNumber.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adp_PickListNumber.ViewHolder holder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ((PickReversalActivity) context).setdonumber(mList.get(getPosition()).getPicklistNo(),mList.get(getAdapterPosition()).getPick_listHdrId());
