...
public class CartonHeaderListActivity extends AppCompatActivity {
    ...
    SQLiteDatabase sql;
    private static Adp_CartonListData adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ut = new Utility();
        cf = new CommonFunction(CartonHeaderListActivity.this);
        String settingKey = ut.getSharedPreference_SettingKey(CartonHeaderListActivity.this);
        String dabasename = ut.getValue(CartonHeaderListActivity.this, WebUrlClass.GET_DATABASE_NAME_KEY, settingKey);
        db = new DatabaseHandlers(CartonHeaderListActivity.this, dabasename);
        sql = db.getWritableDatabase();
        CompanyURL = ut.getValue(CartonHeaderListActivity.this, WebUrlClass.GET_COMPANY_URL_KEY, settingKey);
        EnvMasterId = ut.getValue(CartonHeaderListActivity.this, WebUrlClass.GET_EnvMasterID_KEY, settingKey);
        PlantMasterId = ut.getValue(CartonHeaderListActivity.this, WebUrlClass.GET_PlantID_KEY, settingKey);
        LoginId = ut.getValue(CartonHeaderListActivity.this, WebUrlClass.GET_LOGIN_KEY, settingKey);
        Password = ut.getValue(CartonHeaderListActivity.this, WebUrlClass.GET_PSW_KEY, settingKey);
        UserMasterId = ut.getValue(CartonHeaderListActivity.this, WebUrlClass.GET_USERMASTERID_KEY, settingKey);
        UserName = ut.getValue(CartonHeaderListActivity.this, WebUrlClass.GET_USERNAME_KEY, settingKey);
        IsChatApplicable = ut.getValue(CartonHeaderListActivity.this, WebUrlClass.GET_ISCHATAPPLICABLE_KEY, settingKey);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(CartonHeaderListActivity.this);
        recycler.setLayoutManager(layoutManager);
        adapter=new Adp_CartonListData(cartonDataArrayList);
        ...
        getSupportActionBar().setTitle("Pack Order :"+PackOrderNo);
    ...
    private class GetCartonList extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                res = ut.OpenConnection(url, CartonHeaderListActivity.this);
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.contains("CartonHeaderId")) {
                ...
                Toast.makeText(CartonHeaderListActivity.this, "Server Time Out...", Toast.LENGTH_LONG).show();
            }
    ...
    protected void onResume() {
        ...
        if (isnet()) {
            ...
            try {
                ...
                new StartSession(CartonHeaderListActivity.this, new CallbackInterface() {
                    @Override
            ...
            Toast.makeText(CartonHeaderListActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
        }
    ...
    private void Packetdeletedialog(final String DONumber, final String pack_OrdHdrId) {
        ...
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(CartonHeaderListActivity.this);
        LayoutInflater inflater = CartonHeaderListActivity.this.getLayoutInflater();
        ...
        btn_full.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                                ...
                                startActivity(new Intent(CartonHeaderListActivity.this, UnPackingCartonDetailActivity.class)
