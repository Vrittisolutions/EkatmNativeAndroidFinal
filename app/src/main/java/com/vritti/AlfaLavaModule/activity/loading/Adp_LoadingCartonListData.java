...
public class Adp_LoadingCartonListData extends RecyclerView.Adapter<Adp_LoadingCartonListData.ViewHolder> {
    private List<CartonData> mList;
    private static MyClickListener myClickListener;
    static Context context;


    public Adp_LoadingCartonListData(List<CartonData> list) {
        this.mList = list;
    }

    @Override
    public Adp_LoadingCartonListData.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adp_LoadingCartonListData.ViewHolder holder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
           ...
           /* ((CartonLabelHeaderListActivity) context).setdonumber
