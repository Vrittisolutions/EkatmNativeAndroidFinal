...
public class Adp_LoadingPackOrder extends RecyclerView.Adapter<Adp_LoadingPackOrder.ViewHolder> {
    private List<PicklistNO> mList;
    private static MyClickListener myClickListener;
    static Context context;


    public Adp_LoadingPackOrder(List<PicklistNO> list) {
        this.mList = list;
    }

    @Override
    public Adp_LoadingPackOrder.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adp_LoadingPackOrder.ViewHolder holder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ((LoadingPackOrderListActivity) context).setdonumber
