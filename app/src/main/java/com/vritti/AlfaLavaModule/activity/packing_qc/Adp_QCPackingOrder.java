...
public class Adp_QCPackingOrder extends RecyclerView.Adapter<Adp_QCPackingOrder.ViewHolder> {
    private List<PicklistNO> mList;
    private static MyClickListener myClickListener;
    static Context context;


    public Adp_QCPackingOrder(List<PicklistNO> list) {
        this.mList = list;
    }

    @Override
    public Adp_QCPackingOrder.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adp_QCPackingOrder.ViewHolder holder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ((QCPackingOrderListActivity) context).setdonumber
