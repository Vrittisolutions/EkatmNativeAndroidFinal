...
public class Adp_QCCartonListData extends RecyclerView.Adapter<Adp_QCCartonListData.ViewHolder> {
    private List<CartonData> mList;
    private static MyClickListener myClickListener;
    static Context context;


    public Adp_QCCartonListData(List<CartonData> list) {
        this.mList = list;
    }

    @Override
    public Adp_QCCartonListData.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adp_QCCartonListData.ViewHolder holder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ((QCCartonHeaderListActivity) context).setdonumber
