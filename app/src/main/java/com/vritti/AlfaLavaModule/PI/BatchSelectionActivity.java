...
import com.vritti.inventory.physicalInventory.activity.AudiScreenActivity;
...
public class BatchSelectionActivity extends AppCompatActivity {
    ...
    com.vritti.AlfaLavaModule.PI.BatchListAdapter batchListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pi_batch_list);
    ...
    public void init(){
        ...
        txt_blank = findViewById(R.id.txt_blank);
       ...
       /* Costatus = intent.getStringExtra("Costatus");
        ...
        if(isBatchSelected){
            ...
            if (Costatus.equals("Counter")){
                ...
                String PICode=sharedPrefs.getString("PICode","");
                txtbatchbo.setText(PICode);
    ...
    public void setListeners(){
        ...
        btn_create_batch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(BatchSelectionActivity.this, CreateBatchActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
               // startActivity(new Intent(BatchSelectionActivity.this, LocationScanner.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
        ...
        listbatch.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                startActivity(new Intent(BatchSelectionActivity.this,
                        LocationScanner.class)
                        .putExtra("PICode",batchListArrayList.get(position).getCode()).
                                putExtra("PIHeaderID",batchListArrayList.get(position).getPIHdrId()
                ...
                editor.putString("PICode",batchListArrayList.get(position).getCode());
                editor.putString("PIHeaderID",batchListArrayList.get(position).getPIHdrId());
                editor.commit();
        ...
        btncontinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isnet()) {
                 ...
                 if (Costatus.equals("Counter")){
                     String PICode=sharedPrefs.getString("PICode","");
                     String PIHeaderID=sharedPrefs.getString("PIHeaderID","");
                     startActivity(new Intent(BatchSelectionActivity.this,
                             LocationScanner.class)
    ...
    class DownloadBatchlistData extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String integer) {
            ...
            if (response.contains("[]")||response.equalsIgnoreCase("null")) {
                try{
                    batchListArrayList.clear();
                    batchListAdapter = new com.vritti.AlfaLavaModule.PI.BatchListAdapter(parent, batchListArrayList);
                    if (batchListAdapter.getCount()!=0){
    ...
    private void parseJson(String response) {
        ...
        try {
            ...
            for (int i = 0; i < jResults.length(); i++) {
                ...
                try {
                    BeanTag beanTag = new BeanTag(batchCODE, batchHDR,0);
