...
public class LocationScanner extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(PICode);
        ...
        img_barcode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                IntentIntegrator integrator = new IntentIntegrator(LocationScanner.this);
...
/*[{"LocationMasterId":"0036344d-6f13-4869-a0c9-adedae1baefe",
                    ...
                    startActivity(new Intent(LocationScanner.this, PacketScanDetails.class)
