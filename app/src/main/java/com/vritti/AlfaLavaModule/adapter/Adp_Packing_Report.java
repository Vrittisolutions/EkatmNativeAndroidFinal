...
public class Adp_Packing_Report extends RecyclerView.Adapter<Adp_Packing_Report.ViewHolder> {
    private List<PicklistNO> mList;
    private static MyClickListener myClickListener;
    static Context context;


    public Adp_Packing_Report(List<PicklistNO> list) {
        this.mList = list;
    }

    @Override
    public Adp_Packing_Report.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adp_Packing_Report.ViewHolder holder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ((PackingDONOReportActivity) context).setdonumber(mList.get(getPosition()).getPicklistNo(),mList.get(getAdapterPosition()).getPick_listHdrId());
