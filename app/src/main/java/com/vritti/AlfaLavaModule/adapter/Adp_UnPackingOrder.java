...
public class Adp_UnPackingOrder extends RecyclerView.Adapter<Adp_UnPackingOrder.ViewHolder> {
    private List<PicklistNO> mList;
    private static MyClickListener myClickListener;
    static Context context;


    public Adp_UnPackingOrder(List<PicklistNO> list) {
        this.mList = list;
    }

    @Override
    public Adp_UnPackingOrder.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adp_UnPackingOrder.ViewHolder holder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ((UpPackingOrderListActivity) context).setdonumber
