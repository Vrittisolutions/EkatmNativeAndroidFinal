...
import com.vritti.AlfaLavaModule.activity.SummaryDONOReportActivity;
...
public class Adp_Summary_Report extends RecyclerView.Adapter<Adp_Summary_Report.ViewHolder> {
    private List<PicklistNO> mList;
    private static MyClickListener myClickListener;
    static Context context;


    public Adp_Summary_Report(List<PicklistNO> list) {
        this.mList = list;
    }

    @Override
    public Adp_Summary_Report.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adp_Summary_Report.ViewHolder holder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ((SummaryDONOReportActivity) context).setdonumber(mList.get(getPosition()).getPicklistNo(),mList.get(getAdapterPosition()).getPick_listHdrId());
