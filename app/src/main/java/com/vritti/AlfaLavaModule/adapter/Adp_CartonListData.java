...
public class Adp_CartonListData extends RecyclerView.Adapter<Adp_CartonListData.ViewHolder> {
    private List<CartonData> mList;
    private static MyClickListener myClickListener;
    static Context context;


    public Adp_CartonListData(List<CartonData> list) {
        this.mList = list;
    }

    @Override
    public Adp_CartonListData.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adp_CartonListData.ViewHolder holder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ((CartonHeaderListActivity) context).setdonumber
