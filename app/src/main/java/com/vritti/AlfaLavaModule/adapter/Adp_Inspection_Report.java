...
import com.vritti.AlfaLavaModule.activity.InspectionReportActivity;
...
public class Adp_Inspection_Report extends RecyclerView.Adapter<Adp_Inspection_Report.ViewHolder> {
    private List<PicklistNO> mList;
    private static MyClickListener myClickListener;
    static Context context;


    public Adp_Inspection_Report(List<PicklistNO> list) {
        this.mList = list;
    }

    @Override
    public Adp_Inspection_Report.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adp_Inspection_Report.ViewHolder holder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ((InspectionReportActivity) context).setdonumber(mList.get(getPosition()).getPicklistNo());
