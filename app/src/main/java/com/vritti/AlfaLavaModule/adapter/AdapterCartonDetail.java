...
public class AdapterCartonDetail extends RecyclerView.Adapter<AdapterCartonDetail.ViewHolder> {
    ...
    public AdapterCartonDetail(ArrayList<CartonDetail> countries, Context context) {
        this.list = countries;
