...
public class EntityType_Currency_PriceList {
    String EntityTypeMasterId, EntityTypeCode, EntityType,
            IsDeleted, AddedBy, AddedDt, ModifiedBy, ModifiedDt, PriceListClassificationId, Entity,
            EntityAs, IsPartner, AccountMasterId;

    String CurrencyMasterId, CurrDesc,CurrCode;
