...
public class WhomBean {
    ...
    public WhomBean(String description, String orderTypeMasterId) {
        this.orderTypeMasterId = orderTypeMasterId;
        this.description = description;
    }

    public WhomBean(String description, String orderTypeMasterId, String s, String s1) {
        this.orderTypeMasterId = orderTypeMasterId;
        this.description = description;
    }

    public WhomBean(String userLoginId, String vWBUsermasterId, String userName) {
