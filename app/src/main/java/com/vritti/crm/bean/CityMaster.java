...
public class CityMaster {
    ...
    String CityName;
    String FKCountryId;
    String FKTalukaId,FKDistrictId,FKStateId,PinCode,FKTerritoryId,AddedBy,AddedDt,ModifiedBy,ModifiedDt,IsDeleted;



    public CityMaster(String PKCityID, String CityName) {
