...
public class SubTeamMemberAdapter extends BaseAdapter {
    ...
    String Usermasterid="";
    public SubTeamMemberAdapter(Context context, ArrayList<TeamMemberbean> TeamMemberBeanArrayList) {
       ...
       /* holder.textcollection.setOnClickListener(new View.OnClickListener() {
        ...
        holder.len_assign.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                context.startActivity(intent);
                ((SubTeamMemberActivity) context).overridePendingTransition(R.anim.slide_right_to_left,R.anim.slide_left_to_right);
    ...
    static class ViewHolder {
        TextView textassigned, textname, textoverdue, texttoday, textcollection, texthot,texttomorrow,text_review,txt_warm;
