...
public class CustomAdapterContactList extends BaseAdapter {
    ...
    List<String> lstDept;
    Dialog d_contact;
    AlertDialog d_contact1;
    // public Resources res;
    ProspectContact tempValues;
    int i = 0;

    public CustomAdapterContactList(Context context, List<ProspectContact> d) {
    ...
    public CustomAdapterContactList() {
    ...
    public void updateList(List<ProspectContact> lstContact) {
        data = lstContact;
        ...
        if (data.size() <= 0) {
            ...
            holder.buttonEdit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((ProspectEnterpriseActivity)context).editContactDetails(position,tempValues);
                }
            });
            //   Toast.makeText(activity, "LoName" + tempValues.getName(), Toast.LENGTH_LONG).show();
            // AddContactPopup();


            //d_contact1.setContentView(R.layout.crm_popupaddcontact);


                    /*d_contact = new Dialog(ProspectEnterpriseActivity.this);
                    ...
                    lp.height = WindowManager.LayoutParams.WRAP_CONTAENT;
...
/*
                    ...
                    final Button btnSave = ((Button) d_contact1.findViewById(R.id.btnpopupSaveContact));
                    final Button btnCancel = ((Button) d_contact1.findViewById(R.id.btnpopupCancelContact));
                    final EditText eName = ((EditText) d_contact1.findViewById(R.id.eContactName));

                    final EditText eDesignation = ((EditText) d_contact1.findViewById(R.id.eContactDesignation));
                    final EditText eBirthdate = ((EditText) d_contact1.findViewById(R.id.eBirthdate));
                    final Spinner sDepartmnt = ((Spinner) d_contact1.findViewById(R.id.sDepartment));

                    final EditText cEmailId = (EditText) d_contact1.findViewById(R.id.econtactpEmailid);
                    final EditText cMobilee = (EditText) d_contact1.findViewById(R.id.econtactpMobile);
                    final EditText cTele = (EditText) d_contact1.findViewById(R.id.eContactpTele);
                    final EditText cFaxe = (EditText) d_contact1.findViewById(R.id.eContactpFax);
                    final EditText econtactwhatsapp = (EditText) d_contact1.findViewById(R.id.econtactwhatsapp);
