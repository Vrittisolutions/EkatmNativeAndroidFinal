...
import com.vritti.crm.vcrm7.ContactShowActivity;
...
public class OpportunityAdapter extends RecyclerView.Adapter<OpportunityAdapter.OpportunityHolder> {
    Context context;
    ...
    public OpportunityAdapter(Context context, ArrayList<PartialCallList> partialCallLists) {
       ...
       */
        ...
        if (actid != null||actid.equalsIgnoreCase("")) {
            if (actid.equalsIgnoreCase(partialCallListArrayList.get(i).getCallId())) {
                ...
                if (i % 2 == 1) {
                    holder.len_call.setBackgroundColor(Color.parseColor("#DBE8EA"));
                } else {
                    holder.len_call.setBackgroundColor(Color.parseColor("#F1F6F7"));
                }
            }
        }
...
*/
    ...
    public class OpportunityHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout realcolors, laycall_type,len_action,len_call;
        ...
        public OpportunityHolder(View convertView) {
            ...
            len_call =convertView.findViewById(R.id.len_call);

            txt_chat.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((OpportunityActivity)context).ChatClick(getAdapterPosition(),partialCallListArrayList);
                }
            });
...
*/
            ...
            img_contact.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   String  Call_ProspectId = partialCallListArrayList.get(getPosition()).getPKSuspectId();
                    ...
                    Intent intent = new Intent(context, ContactShowActivity.class);
            ...
            len_call.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    ((OpportunityActivity)context).longPress(getAdapterPosition());
