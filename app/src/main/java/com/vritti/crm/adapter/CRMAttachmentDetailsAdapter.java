...
public class CRMAttachmentDetailsAdapter extends RecyclerView.Adapter<CRMAttachmentDetailsAdapter.AttachmentHolder> {
    Context context;
    ...
    public CRMAttachmentDetailsAdapter(Context context, ArrayList<AttachmentBean> attachmentList, boolean isEdit) {

        this.attachmentlist = attachmentList;
        this.context = context;
        this.isEdit = isEdit;
    }
    public CRMAttachmentDetailsAdapter(ArrayList<String> attachmentList, boolean isEdit) {
    ...
    @NonNull
    @Override
    public CRMAttachmentDetailsAdapter.AttachmentHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
