    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent.hasExtra("type")){
            ...
            if(!endtime.equals("")){
                ...
                String count = calculate_time_diff(Start, currentTime);
...
//+ ":"+ String.format("%03d", milliseconds)
    ...
    private void init() {
        ...
        img_contact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(OpportunityUpdateActivity.this, ContactActivity.class);
    ...
    class PostOpportunityUpdateJSON extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String integer) {
            ...
            if (integer.equals("Success")) {
                ...
                // onBackPressed();
                Intent i = new Intent(OpportunityUpdateActivity.this, CRMHomeActivity.class);
    ...
    void UpdateOpportunity(final String finaljson1) {
        if ((finaljson1.equalsIgnoreCase("") &&
            ...
            String remark1 = "Opportunity update";
            String url = CompanyURL + WebUrlClass.api_getPostOppUpdate;
            String op = "Success";
            ...
            try {
                Intent serviceIntent = new Intent(OpportunityUpdateActivity.this, ForegroundService.class);
