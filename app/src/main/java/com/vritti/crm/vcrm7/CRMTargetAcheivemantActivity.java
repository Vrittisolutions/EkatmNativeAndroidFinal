...
public class CRMTargetAcheivemantActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.crm_day_end_report_activity);
        ...
        txt_title.setText("Target Acheivement");
