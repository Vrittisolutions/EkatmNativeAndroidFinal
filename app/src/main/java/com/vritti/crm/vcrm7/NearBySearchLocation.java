...
public class NearBySearchLocation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Google Script");
        ...
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(NearBySearchLocation.this);
        ...
        img_location.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(NearBySearchLocation.this, LocationSelectActivity.class);
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<HashMap<String, String>>> {
        ...
        protected void onPostExecute(List<HashMap<String, String>> list) {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                nearBySearchAdapter = new NearBySearchAdapter(NearBySearchLocation.this, nearBySearchDataArrayList);

                LinearLayoutManager linearLayoutManager = new LinearLayoutManager(
                        NearBySearchLocation.this,
    ...
    private void getLocation() {
        if (ActivityCompat.checkSelfPermission(
                NearBySearchLocation.this,Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(
                NearBySearchLocation.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
