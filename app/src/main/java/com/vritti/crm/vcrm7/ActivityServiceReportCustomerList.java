...
import com.vritti.crm.adapter.AdapterCustmerList;
...
public class ActivityServiceReportCustomerList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_title.setText("Service Report");
       ...
       UserName = ut.getValue(context, WebUrlClass.GET_USERNAME_KEY, settingKey);        sql = db.getWritableDatabase();
