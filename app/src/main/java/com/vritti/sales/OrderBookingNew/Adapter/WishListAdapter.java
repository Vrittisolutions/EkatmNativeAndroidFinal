...
import com.vritti.sales.OrderBookingNew.WishlistActivity;
...
public class WishListAdapter extends BaseAdapter {
    ...
    public WishListAdapter(Context context, ArrayList<MyCartBean> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        try{
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.cartadapter, null);
        ...
        holder.product_qty.addTextChangedListener(new TextWatcher() {
                    ...
                    if((ss > maxOrdLimit || ss < minOrdLimit) && (maxOrdLimit != 0 || maxOrdLimit != 0.0)){
                     ...
                     //   Toast.makeText(parent,""+parent.getResources().getString(R.string.maxordlimit),Toast.LENGTH_SHORT).show();
                        ...
                        if (decimal_digit == 0) {
                            ...
                            //holder.product_qty.setFilters(new InputFilter[]{new DecimalDigitsInputFilter(7, decimal_digit)});
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (((s.toString().trim() == "") || (s.toString() == null) || (s
                    ...
                    float p = 0;
                    float youSave = (arrayList.get(position).getMrp() *p)  - ((Float.parseFloat(arrayList.get(position).getPrice()))*p);
                ...
                if(parent instanceof WishlistActivity){
                    ((WishlistActivity)parent).calculate_total();
                }
        ...
        holder.btndelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(parent instanceof WishlistActivity){
                    ((WishlistActivity)parent).deleteItemFromCart(
        ...
        holder.imgitm.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if(parent instanceof WishlistActivity){
                    ((WishlistActivity)parent).expandImage(arrayList.get(position).getItemImgPath(),
