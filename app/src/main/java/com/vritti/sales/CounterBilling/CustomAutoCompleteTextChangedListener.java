    ...
    public void onTextChanged(CharSequence userInput, int start, int before, int count) {
        ...
        try{
           ...
           // Log.e(TAG, "User input: " + userInput);
            ...
            ItemListCB mainActivity = ((ItemListCB) context);

            // update the adapater
            mainActivity.myAdapter.notifyDataSetChanged();

            // get suggestions from the database
            AllCatSubcatItems[] myObjs = tcf.getCBItemList(userInput.toString());

            mainActivity.myAdapter = new AutocompleteCustomArrayAdapter(mainActivity, R.layout.tbuds_list_view_row_item, myObjs);
