...
/**
 * Created by sharvari on 7/30/2016.
 */
public class DailySaleActivity extends AppCompatActivity {
        ...
        if (tcf.getReportsCount() > 0) {
            if (itemdata.equalsIgnoreCase("All Items")) {
                ...
                if (tcf.getReportsCount() > 0) {
                    ...
                    Toast.makeText(DailySaleActivity.this, "No data", Toast.LENGTH_SHORT).show();
                }
            } else {
                if (tcf.getReportsCount() > 0) {
                    reportsArrayList.clear();
    ...
    private void init() {
        ...
        ut = new Utility();
        tcf = new Tbuds_commonFunctions(DailySaleActivity.this);
        ...
        if (reportsArrayList.size() == 0) {
            ...
            if (c.getCount() > 0) {
                ...
                do {
                    ...
                    Item = c.getString(c.getColumnIndex("purchaseitemName"));
                    itemid = c.getString(c.getColumnIndex("purchaseitemid"));
                    Purchasecost = Purchasecost + Float.parseFloat(c.getString(c.getColumnIndex("purchasemrp")));
                    broughtqty = broughtqty + Float.parseFloat(c.getString(c.getColumnIndex("purchaseqty")));
    ...
    private void addView(int i) {
        final int pos = i;
        LayoutInflater layoutInflater = (LayoutInflater) DailySaleActivity.this
    ...
    private void getDataFromServer() {
        ...
        if (cd.isConnectingToInternet()) {
            if ((AnyMartData.SESSION_ID != null)
                ...
                new StartSession_tbuds(DailySaleActivity.this, new CallbackInterface() {
