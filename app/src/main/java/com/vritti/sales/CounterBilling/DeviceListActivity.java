...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tbuds_device_list);   //��ʾ�б����
    ...
    public void init(){
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter<String>(this, R.layout.tbuds_device_name);
        mNewDevicesArrayAdapter = new ArrayAdapter<String>(this, R.layout.tbuds_device_name);
        ...
        ut = new Utility();
        tcf = new Tbuds_commonFunctions(DeviceListActivity.this);
