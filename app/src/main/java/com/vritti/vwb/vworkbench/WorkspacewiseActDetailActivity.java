...
*/
            ...
            } else if (Mode.equalsIgnoreCase( "UN")) {
                jsonObj = jsoncommonObj.getJSONObject("IsSystemGenerated");
                jsonObj.put("IsSet", true);


                jsonObj = jsoncommonObj.getJSONObject("IsUnplanned");
                jsonObj.put("IsSet", true);
