...
import com.vritti.vwb.Adapter.ClaimDetailsFrangentAdapter;
import com.vritti.ekatm.R;
import com.vritti.vwb.vworkbench.ClaimDetailActivity;
...
public class ClaimDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (com.vritti.vwb.vworkbench.ClaimDetailActivity.lsCalimDetails.size() > 0&&adapter!=null) {
            adapter = new ClaimDetailsFrangentAdapter(getContext(), com.vritti.vwb.vworkbench.ClaimDetailActivity.lsCalimDetails);
    ...
    private void setListner() {
        btn_add_claim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), com.vritti.vwb.vworkbench.ClaimDetailActivity.class);
