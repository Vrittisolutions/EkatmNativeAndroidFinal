...
import com.vritti.vwb.Adapter.AutocompleteReassignAdapter;
import com.vritti.ekatm.R;
import com.vritti.vwb.classes.CommonFunction;
import com.vritti.vwb.classes.CustomAutoCompleteTextChangedListener;
...
public class ReassignActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acitivity_reassign_activity);
        ...
        protected void onPostExecute(String resp) {
            ...
            if (resp.contains("success")) {
                ...
                if (flag_fromTeam == 0) {
                    ...
                    Intent intent = new Intent(ReassignActivity.this, com.vritti.vwb.vworkbench.ActivityMain.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                } else {
                    sql.delete(db.TABLE_ACTIVITYMASTER_TEAM, "ActivityId=?", new String[]{Activityid});
                    Toast.makeText(ReassignActivity.this, "Activity Reassign successfully", Toast.LENGTH_LONG).show();
