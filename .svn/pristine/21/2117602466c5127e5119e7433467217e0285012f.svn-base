...
import com.vritti.inventory.physicalInventory.activity.BluetoothClass_QSPrinter;
import com.vritti.inventory.physicalInventory.activity.CounterAuditorSelectActvity;
import com.vritti.inventory.physicalInventory.activity.Devicelist_NewPrinterSetting;
...
public class BluetoothConnectivityActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent.setClass(BluetoothConnectivityActivity.this, BatchSelectionActivity.class);
        startActivity(intent);
        PrintService.imageWidth = 72;
    }
