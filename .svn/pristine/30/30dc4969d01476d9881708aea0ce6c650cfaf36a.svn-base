...
import com.vritti.vwblib.Beans.Username;
...
public class EmployeeAdvanceRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Employee Advance Request");
    ...
    private void init() {
        ...
        txt_send_request.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Amount.length() > 0 && !Amount.equals("0")) {
...
*/
    ...
    private void CreateOfflineModeReschedule(final String url, final String parameter,
        ...
        if (a != -1) {
            ...
            Intent intent = new Intent(EmployeeAdvanceRequestActivity.this, ActivityMain.class);
