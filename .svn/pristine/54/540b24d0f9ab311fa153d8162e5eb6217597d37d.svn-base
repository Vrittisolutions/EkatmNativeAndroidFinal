...
/*public class DeviceLablelPrint extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_devicelist__lablel_print);
    }
}*/
/*
 ...
 */
public class DeviceLablelPrint extends Activity {
    // Return Intent extra
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.alfa_activity_device_list);
