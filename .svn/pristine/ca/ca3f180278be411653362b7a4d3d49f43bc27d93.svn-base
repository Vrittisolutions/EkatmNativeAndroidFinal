...
public class AddUserAdapterForGroup extends RecyclerView.Adapter<AddUserAdapterForGroup.AddUserHolder> {

    Context context;
    ArrayList<ChatUser> chatUserArrayList;
    public AddUserAdapterForGroup(Context context1, ArrayList<ChatUser> chatUserArrayList) {
    ...
    public void updateList(ArrayList<ChatUser> chatUserArrayList) {
        this.chatUserArrayList = chatUserArrayList;
        notifyDataSetChanged();
    }

    public void updatePostion(int adapterPosition) {
        this.chatUserArrayList = chatUserArrayList;
    ...
    public class AddUserHolder extends RecyclerView.ViewHolder {
        ...
        void chatUser(){
            ((AddGroupActivity)context).setUserSelectiom(checkbox_user.isChecked() , getAdapterPosition());
