...
public class ProvisionalData implements Serializable {

    String CollectionReceiptMasterId,InvoiceNo,CustomerId,CallId,Amount,InstrumentNo,BankName,TDSAmount,Narration,ReceiptStatus,AddedBy,AddedDt,PaymentDepBank,DepositedDt;
