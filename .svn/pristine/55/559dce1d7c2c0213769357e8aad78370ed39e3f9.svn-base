...
import com.vritti.vwb.Adapter.MySubteamActivityAdapter;
...
public class MySubTeamActivity extends AppCompatActivity {
    ...
    ListView teamlist;
    private ArrayList<MyTeamDeptBean> Mysubteam;
    MySubteamActivityAdapter mysubteamActivityAdapter;
    String DeptID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vwb_activity_mysubteam);
    ...
    private void initObj() {
        ...
        Mysubteam = new ArrayList<MyTeamDeptBean>();
       ...
       // mProgress = (ProgressBar) findViewById(R.id.toolbar_progress_App_bar);
        ...
        location.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent2 = new Intent(MySubTeamActivity.this, GPSTeamList.class);
    ...
    private void getData() {
      //  showProgressDialog();
        new StartSession(MySubTeamActivity.this, new CallbackInterface() {
            @Override
    ...
    private void updateTeam() {
        ...
        if (cur.getCount() > 0) {
            ...
            mysubteamActivityAdapter = new MySubteamActivityAdapter(MySubTeamActivity.this, Mysubteam);
            teamlist.setAdapter(mysubteamActivityAdapter);
        }
       // sql.close();
    }
