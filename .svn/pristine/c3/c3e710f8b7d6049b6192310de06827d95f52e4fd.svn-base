...
public class PaidLocationFusedLocationTracker1 extends Service implements LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent intent1 = new Intent(this, ActivityModuleSelection.class);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this, CHANNEL_ID)
                    ...
                    .setContentTitle(getResources().getString(R.string.Location_service_running_status))
            ...
            intent = new Intent(this, ActivityModuleSelection.class);
   ...
   /* @Override
    ...
    public void onCreate() {
      ...
      /*  if (Build.VERSION.SDK_INT >= 26) {
            Intent notificationIntent = new Intent(this, ActivityModuleSelection.class);
            ...
            Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
                    ...
                    .setContentText("Location getting")
            ...
            bigTextStyle.setBigContentTitle(getResources().getString(R.string.Location_service_running_status));
            bigTextStyle.bigText(getResources().getString(R.string.Location_service_running_status));
            // Set big text style.
            builder.setStyle(bigTextStyle);
            // builder.setWhen(System.currentTimeMillis());
            builder.setSmallIcon(R.mipmap.ic_toolbar_logo_vwb);
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                if (latitude == 0.0 && longitude == 0.0) {
                    ...
                    if (check_GPSrecords(Currenttime) > 0) {
                        ...
                        cf.addGps(MobileNo, String.valueOf(latitude),
    ...
    class GetCheckIsOffDay extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String integer) {
            ...
            try {
                ...
                editor.putString(WebUrlClass.USERINFO_OFF_DAY, res);
                offday = res;
                editor.commit();
