...
import com.vritti.crmlib.chat.AddGroupActivity;
...
public class OpenChatroomActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        edt_search_chatroomname = (EditText) findViewById(R.id.edt_search_chatroomname);
    ...
    private void getchatroomsearch(String name) {
        chatRoomDisplayArrayList.clear();
        String query = "SELECT * FROM " + db.TABLE_CHAT_CHATROOM_GROUP_LIST + " WHERE  ChatRoomName like '%" + name + "%'order by StartTime desc ";
        ;
