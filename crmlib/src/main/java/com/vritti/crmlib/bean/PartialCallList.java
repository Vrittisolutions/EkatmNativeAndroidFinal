...
public class PartialCallList {

    String firmname,  cityname , cityterritoryname ,  CallId ,  productname  , actionicon   , actiondatetime ,  assignedby , isPartial,  mobileno,LatestRemark;
String CallType,CallStatus,ContactName,PKSuspectId,Product,Amount,InvoiceNo,InvoiceDt,UnAllocatedCash,ProvisionalCount,ChatRoomId,ChatCount,FamilyDesc,emailid,source;

    public String getProvisionalCount() {
        return ProvisionalCount;
    }

    public void setProvisionalCount(String provisionalCount) {
