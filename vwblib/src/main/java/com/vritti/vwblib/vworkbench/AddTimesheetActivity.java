...
public class AddTimesheetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ValidBackDate = timesheetpreferences.getString("ValidBackDate", "");
        IsTimeslotBooked = timesheetpreferences.getString("IsTimeslotBooked", "");
        Intent i = getIntent();
    ...
    class DownloadTimesheetTme extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String integer) {
            ...
            if (!(TimesheetFromTime.equalsIgnoreCase("NoValue"))) {
                ...
                try {
                    currentDateandTime = sdf.parse(TimesheetFromTime);
                    TimesheetFromTime = sdf.format(currentDateandTime);
                } catch (Exception e) {
                    e.printStackTrace();
                }
