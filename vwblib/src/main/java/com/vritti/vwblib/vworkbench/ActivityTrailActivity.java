...
public class ActivityTrailActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar.setTitle(" Activity Trail");
                ...
                if (response != null) {
                    for (int i = 0; i < jResults.length(); i++) {
                        try {
                            ...
                            txt_workspace.setText("Assignment : " + jorder.getString("ProjectName"));
                            txt_maingroup.setText("Audit : " + jorder.getString("ModuleName"));
                            txt_subgroup.setText("Process : " + jorder.getString("UnitDesc"));
