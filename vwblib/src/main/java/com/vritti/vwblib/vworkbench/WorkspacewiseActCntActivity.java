...
import com.vritti.vwblib.Adapter.WorkspacewiseActCntAdapter;
...
public class WorkspacewiseActCntActivity extends AppCompatActivity {
    ...
    class DownloadGetWorkspacewiseActCnt extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                String url = CompanyURL + WebUrlClass.api_getWorkspacewiseActCnt + "?UserMasterId=" + URLEncoder.encode(UserMasterId, "UTF-8");
